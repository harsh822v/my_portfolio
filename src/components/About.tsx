  ...
  return (
    <section id="about" className="py-20 px-4">
      <div className="container mx-auto">
        <h2 className="section-heading reveal fade-bottom">About Me</h2>
        
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mt-12">
          <div className="lg:col-span-2 glass-card p-6 reveal fade-left">
          ...
          <div className="glass-card p-6 flex flex-col justify-between reveal fade-right">
            <div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-3">
                <Button asChild variant="outline" className="w-full justify-start hover:bg-lavender-100 transition-all">
