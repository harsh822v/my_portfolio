  ...
  return (
    <section id="education" className="py-20 px-4 bg-lavender-50">
      <div className="container mx-auto">
        <h2 className="section-heading reveal fade-bottom">Education</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12">
          ...
          <div className="glass-card p-6 hover:shadow-xl transition-all duration-300 animate-fade-in border-t-4 border-lavender-500 reveal fade-bottom" style={{ transitionDelay: '0.3s' }}>
